...
public class revolucionariosAdapter extends  RecyclerView.Adapter<revolucionariosAdapter.InfoViewHolder> {

    private ArrayList<Personaje> lista_personajes;

    public revolucionariosAdapter(ArrayList<Personaje> lista_personajes) {
